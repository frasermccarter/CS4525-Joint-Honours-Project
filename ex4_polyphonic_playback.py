...
It will play all tracks that have been defined up to the point where the play_polyphonic function is called.  
...
#Plays the melody and harmony tracks polyphonically
play_polyphonic(tempo=120)
